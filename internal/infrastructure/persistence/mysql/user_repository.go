...
import (
	...
	"auth-service/internal/infrastructure/persistence/mysql/model"
...
func (r *UserRepository) FindByKeycloakUUID(ctx context.Context, keycloakUUID string) (*user.User, error) {
	var mdl model.UserEntity
	db := GetDB(ctx, r.db)
...
func (r *UserRepository) FindAll(ctx context.Context, req *pagination.PaginationRequest) ([]*user.User, error) {
